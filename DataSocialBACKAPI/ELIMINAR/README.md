...
**DataSocial** es una API REST para una red social que conecta usuarios con intereses similares utilizando una base de datos de grafos Neo4j. La aplicacion recopila metadatos de los usuarios (gustos, hashtags en publicaciones) para construir perfiles comerciales y recomendar publicidad dirigida.
